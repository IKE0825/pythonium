...
df = pd.read_csv(r'C:\Users\ec000248\Documents\Git\python\python_study\suumo.csv', sep='\t', encoding='utf-16')
...
df['賃料料'] = df['賃料料'].str.replace(u'万円', u'')  # ex) 5.7万円 ⇒ 5.7
...
df['管理費'] = df['管理費'].replace('-',0)  #無い場合、0
...
df_search = df_search[["マンション名",'賃料料', '予測値',  '予測値との差', '詳細URL']]
df_search.to_csv(r'C:\Users\ec000248\Documents\Git\python\python_study\otoku.csv', sep = '\t',encoding='utf-16')
